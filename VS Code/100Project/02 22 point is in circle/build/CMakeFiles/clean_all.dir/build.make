...
CMakeFiles/clean_all:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir="E:\2025\learn\VS Code\Project\02 22 point is in circle\build\CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) 彻底清理所有构建产物
	"D:\Program Files (x86)\cmake\bin\cmake.exe" -E remove_directory "E:/2025/learn/VS Code/Project/02 22 point is in circle/build"
	"D:\Program Files (x86)\cmake\bin\cmake.exe" -E remove isInCircle
